...
},...N,...D,...M,S,$,...T,...j,K]}}})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
},{className:"string",begin:/'/,end:/'/},n]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
end:/(?=#)|$/,contains:[b,o,r]},{begin:/\b(print|exec)\(/}]}}})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("gherkin",(()=>{"use strict";return e=>({name:"Gherkin",
aliases:["feature"],
...
className:"string",begin:'"""',end:'"""'},e.QUOTE_STRING_MODE]})})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[E]}]}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("less",(()=>{"use strict";return e=>{
...
subLanguage:"bash"}}]})})());hljs.registerLanguage("prolog",(()=>{"use strict";return n=>{const e={
...
contains:g.concat([{begin:/\.$/}])}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
relevance:0,end:";",contains:[e.UNDERSCORE_TITLE_MODE]},l,c]}}})());hljs.registerLanguage("pgsql",(()=>{"use strict";return E=>{
...
n.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],n}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
