...
var hljs = (function () {
	...
	const d = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)',
		...
		b = function (e, n, t = {}) {
			...
			return a.contains.push(m), a.contains.push({ className: 'doctag', begin: '(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):', relevance: 0 }), a;
		},
		v = b('//', '$'),
		x = b('/\\*', '\\*/'),
		E = b('#', '$');
	...
	return (function (t) {
		...
		function b(e, t, a, s) {
			...
			function h(e) {
				return e.className && O.openNode(e.className), (R = Object.create(e, { parent: { value: R } }));
			}
			function p(e) {
			...
			try {
				...
				return (
					...
					O.finalize(),
					(w = O.toHTML()),
					{ relevance: I, value: w, language: e, illegal: !1, emitter: O, top: R }
				);
			} catch (n) {
				if (n.message && n.message.includes('Illegal'))
					return {
						illegal: !0,
						illegalBy: { msg: n.message, context: o.slice(T - 100, T + 100), mode: n.mode },
						sofar: w,
						relevance: 0,
						value: k(o),
						emitter: O
					};
				if (l) return { illegal: !1, relevance: 0, value: k(o), emitter: O, language: e, top: R, errorRaised: n };
				throw n;
			}
		}
		function v(e, n) {
		...
		Object.assign(t, {
			...
			registerLanguage: function (e, n) {
				...
				r.name || (r.name = e), (i[e] = r), (r.rawDefinition = n.bind(null, t)), r.aliases && I(r.aliases, { languageName: e });
			},
