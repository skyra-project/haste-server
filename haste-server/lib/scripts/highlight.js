...
var hljs = (function () {
	...
	class o {
		...
		static _walk(e, t) {
			return (
				'string' == typeof t ? e.addText(t) : t.children && (e.openNode(t), t.children.forEach((t) => this._walk(e, t)), e.closeNode(t)), e
			);
		}
		static _collapse(e) {
			'string' != typeof e &&
	...
	const u = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./,
		...
		w = (e, t, n = {}) => {
			...
			return i.contains.push(v), i.contains.push({ className: 'doctag', begin: '(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):', relevance: 0 }), i;
		},
		y = w('//', '$'),
		N = w('/\\*', '\\*/'),
		R = w('#', '$');
	...
	return ((e) => {
		...
		function f(e, t, s, l) {
			...
			try {
				...
				if (r) return { illegal: !1, relevance: 0, value: K(t), emitter: k, language: e, top: R, errorRaised: n };
				throw n;
			}
		}
		function p(e, t) {
			...
			const i = ((e) => {
					const t = { relevance: 0, emitter: new u.__emitter(u), value: K(e), illegal: !1, top: g };
		...
		'undefined' != typeof window &&
			...
			Object.assign(e, {
				...
				highlightElement: x,
				highlightBlock: (e) => (
					z('10.7.0', 'highlightBlock will be removed entirely in v12.0'), z('10.7.0', 'Please use highlightElement now.'), x(e)
				),
				configure: (e) => {
					e.useBR &&
				...
				contains: [
					...
					},
					{
						...
						contains: [
							...
							{ className: 'params', begin: /\(/, end: /\)/, keywords: n, relevance: 0, contains: [e.C_BLOCK_COMMENT_MODE] },
							e.C_LINE_COMMENT_MODE,
							e.C_BLOCK_COMMENT_MODE
						]
					},
...
hljs.registerLanguage(
	...
	(() => {
		...
		return (s) => {
			...
			a.contains.push(c);
			const o = { begin: /\$\(\(/, end: /\)\)/, contains: [{ begin: /\d+#[0-9a-f]+/, className: 'number' }, s.NUMBER_MODE, n] },
	...
	(() => {
		...
		return (e) => {
			const n = {
				...
				c = { className: 'class', beginKeywords: 'class enum', end: /\s*[{]/, excludeEnd: !0, relevance: 0, contains: [e.TITLE_MODE] },
				l = {
					className: 'function',
					begin: /function\s+/,
					end: /\s*\{|$/,
...
hljs.registerLanguage(
	...
	(() => {
		...
		return (n) => {
			...
			return (e.contains = g), (a.contains = g), { name: 'Prolog', contains: g.concat([{ begin: /\.$/ }]) };
		};
	})()
);
hljs.registerLanguage(
	...
	(() => {
		...
		return (s) => {
			const a = { className: 'number', relevance: 0, variants: [{ begin: /([+-]+)?[\d]+_[\d_]+/ }, { begin: s.NUMBER_RE }] },
				i = s.COMMENT();
			i.variants = [
				{ begin: /;/, end: /$/ },
				{ begin: /#/, end: /$/ }
				...
				contains: [
					{
						...
						contains: [
							...
							l,
							c,
							{ begin: /\[/, end: /\]/, contains: [{ className: 'meta', begin: /<![a-z]/, end: />/, contains: [r, c, g, l] }] }
						]
					},
					e.COMMENT(/<!--/, /-->/, {
						relevance: 10
		...
		return (a) => {
			...
			return {
				...
				contains: [
					...
					{ begin: ':', end: ';', contains: [c, n.HEXCOLOR, a.CSS_NUMBER_MODE, a.QUOTE_STRING_MODE, a.APOS_STRING_MODE, n.IMPORTANT] },
						...
						c,
						{
							...
							contains: [
								...
								{ className: 'type', begin: /</, end: />/, keywords: 'reified', relevance: 0 },
								{
									...
									relevance: 0,
									contains: [
										{ begin: /:/, end: /[=,\/]/, endsWithParent: !0, contains: [E, e.C_LINE_COMMENT_MODE, b], relevance: 0 },
										e.C_LINE_COMMENT_MODE,
										b,
										l,
										c,
					...
					contains: [
						...
						{ begin: /:/, endsWithParent: !0, contains: [c, o] },
						{
							...
							contains: [
								...
								o,
								s,
								{ begin: /\(/, end: /\)/, keywords: m, relevance: 0, contains: ['self', r, n.C_BLOCK_COMMENT_MODE, c, o, s] }
							]
						},
						s,
						r,
			...
			const c = {
				...
				b = ((i) => {
					const c = e,
						...
						E = { begin: 'html`', end: '', starts: { end: '`', returnEnd: !1, contains: [i.BACKSLASH_ESCAPE, u], subLanguage: 'xml' } },
						m = {
							begin: 'css`',
							end: '',
					...
					const N = [].concat(_, u.contains),
						...
						A = { className: 'params', begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: l, contains: f };
					return {
						name: 'Javascript',
						...
						contains: [
							...
							{ begin: /\b(?=constructor)/, end: /[{;]/, excludeEnd: !0, contains: [i.inherit(i.TITLE_MODE, { begin: c }), 'self', A] },
							{
								begin: '(get|set)\\s+(?=' + c + '\\()',
								end: /\{/,
								keywords: 'get set',
	...
	(() => {
		...
		return (e) => {
			var n = 'true false yes no null',
				...
				r = [...b];
			return r.pop(), r.push(i), (l.contains = r), { name: 'YAML', case_insensitive: !0, aliases: ['yml'], contains: b };
		};
	})()
);
hljs.registerLanguage(
			...
			const n = {
				...
				c = {
					...
					variants: [
						...
						{ begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: n, contains: ['self', a, b, t, e.HASH_COMMENT_MODE] }
					]
				};
			var d;
			return (
